...
2026-09-22 顺序执行入口：[剩余任务统计与 checklist](./docs/operations/2026-09-19-remaining-work-checklist.md)。排除旧兼容映射后，总账 90 项能力中 20 项实现、16 项验证尚未完成；发布/验收仍有各自未关闭范围。恢复主线 R01–R25 中 R01 规格/计划、R02 真实入口本地接线及 R03 后台与隐式写生命周期已完成，3 项关闭、22 项剩余；R03 五个子项均通过本地验证，见[完成边界证据](./docs/operations/evidence/2026-09-21-maintenance-r03-completion.md)。R04 进行中：前 3 个子项真实 Agent 生产者/最终落库、独立取消链和 timeout/race 分类已完成，见[生产者证据](./docs/operations/evidence/2026-09-21-maintenance-r04-producer.md)、[取消链证据](./docs/operations/evidence/2026-09-22-maintenance-r04-cancel.md)及[超时证据](./docs/operations/evidence/2026-09-22-maintenance-r04-timeout.md)；下一项为 typed R2/DO/VFS 原始失败观察。生产入口仍明确 legacy，未启用维护；跨存储安全及完整故障矩阵仍待后续子项。产品增量清单另有 30 个未关闭父项，含已完成子项并与恢复主线重叠，不相加。不提升产品交付四维状态。
