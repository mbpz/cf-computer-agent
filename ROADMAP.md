...
总账成熟度：`atoms=86`; `implementation=done:66,partial:5,pending:15,n/a:0`; `verification=done:70,partial:0,pending:16,n/a:0`; `release=done:0,partial:28,pending:58,n/a:0`; `acceptance=done:0,partial:8,pending:78,n/a:0`
...
范围：`INB-001`、`GL-001`、`TSK-001`、`TSK-002`、`TSK-003`、`TSK-004`、`TSK-005`、`TSK-006`、`TSK-007`、`TSK-008`、`TSK-009`、`TSK-010`、`NTF-001`、`NTF-002`、`NTF-003`、`NTF-004`、`NTF-005`、`NTF-006`、`BRD-001`、`BRD-002`、`BRD-003`、`BRD-004`、`BRD-005`、`BRD-006`、`BRD-007`、`MSG-001`、`MSG-002`、`MSG-003`、`MSG-004`、`MSG-005`、`MSG-006`。
