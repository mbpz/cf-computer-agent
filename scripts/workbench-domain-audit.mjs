...
const DEFAULT_EVIDENCE_PATH = "docs/operations/evidence/2026-09-15-workbench-d01b2-domain-audit.md";
...
export function renderWorkbenchDomainAudit(records) {
  ...
  return [
    "# Workbench D01-B2 Domain Audit — 2026-09-15",
    "",
    "Current 32-capability reconciliation after D01-B2; the D01-B1, D01-A and M02 snapshots are preserved separately. The 2026-08-31 R0 audit remains a separate historical 24-capability snapshot; this artifact does not backdate coverage or promote release/acceptance.",
    "",
