export type PageKind = "home" | "knowledge" | "knowledge-reader" | "search" | "agent" | "submit" | "my-submissions" | "admin" | "admin-submissions" | "admin-assets" | "admin-members" | "admin-spaces" | "admin-audit" | "not-found";
