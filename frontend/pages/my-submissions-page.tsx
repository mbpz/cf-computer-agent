...
export function MySubmissionsPage({ state, locale, pending = false, localError, onPageChange, onPageSizeChange }: { state: { kind: "loading" } | { kind: "ready"; items: readonly MySubmissionItem[]; pagination: { page: number; pageSize: 20 | 50 | 100; total: number; totalPages: number } } | { kind: "error"; message: string }; locale?: LocaleRuntime; pending?: boolean; localError?: string; onPageChange?: (page: number) => void; onPageSizeChange?: (pageSize: 20 | 50 | 100) => void }) {
