...
export function AssetQueuePage({ assets, loading = false, preview = null, onRetry, onPreview, locale }: { assets: readonly { id: string; name?: string; status?: string; warnings?: readonly string[] }[]; loading?: boolean; preview?: AssetPreviewModel | null; onRetry?: (id: string) => void; onPreview?: (id: string) => void; locale?: LocaleRuntime }) {
