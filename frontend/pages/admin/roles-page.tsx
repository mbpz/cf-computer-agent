...
export function AdminRolesPage({ state, locale, onSelect, onSave, onCreate, saving = false, saveError }: { state: RolePageState; locale?: LocaleRuntime; onSelect?: (id: string) => void; onSave?: (role: AdminRole, allowBits: string) => void; onCreate?: (input: { key: string; name: string; allowBits: string }) => void; saving?: boolean; saveError?: string | null }) {
  ...
  return <RoleEditor roles={state.roles} locale={locale} onSelect={onSelect} onSave={onSave} onCreate={onCreate} saving={saving} saveError={saveError} />;
}

function RoleEditor({ roles, locale, onSelect, onSave, onCreate, saving, saveError }: { roles: readonly AdminRole[]; locale?: LocaleRuntime; onSelect?: (id: string) => void; onSave?: (role: AdminRole, allowBits: string) => void; onCreate?: (input: { key: string; name: string; allowBits: string }) => void; saving: boolean; saveError?: string | null }) {
