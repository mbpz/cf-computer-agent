  ...
  return {
    prepare() {
      const statement = {
        ...
        first: async () => null,
        run: async () => ({ results: [], success: true, meta: { changes: 0, duration: 0, last_row_id: 0, rows_read: 0, rows_written: 0, served_by: 'test', served_by_region: 'test', served_by_primary: true, total_attempts: 1 } }),
