...
const run = { id: "run-1", ownerMemberId: "member-1", knowledgeItemId: "k-1", goal: "比较落地方案", plan: { spaceIds: [], collectionIds: [], knowledgeItemIds: [], completion: ["形成有引用结论"] }, status: "draft" as const };
const sources = [{
