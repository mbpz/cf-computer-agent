...
describe("audit input validation", () => {
  ...
  it.each([
    ...
    ["knowledge.downloaded", "knowledge", { revisionId: "revision-1" }],
  ...
  it.each([
    ...
    ["knowledge.downloaded", "knowledge", { revisionId: "revision-1", content: "private markdown" }],
    ...
    ["knowledge.purged", "knowledge", { currentRevisionId: "revision-1", purgedRevisionCount: 2, content: "private markdown" }],
