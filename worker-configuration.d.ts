/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=config/types.env` (hash: 45add7ce29fdac6f11b706d9aeae285e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_INSECURE_LOCAL">> {}
}
