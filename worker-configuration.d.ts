/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=config/types.env` (hash: a7cc75dc09b38764a4f1c21fdf07d66c)
...
interface __BaseEnv_Env {
	...
	KNOWLEDGE: DurableObjectNamespace<import("./src/index").KnowledgeBase>;
	AGENT_SESSIONS: DurableObjectNamespace<import("./src/index").AgentSession>;
	MAINTENANCE: DurableObjectNamespace<import("./src/index").MaintenanceCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "KnowledgeBase" | "AgentSession" | "MaintenanceCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_INSECURE_LOCAL" | "GITHUB_OAUTH_CLIENT_ID" | "GITHUB_OAUTH_CLIENT_SECRET" | "BOOTSTRAP_ADMIN_EMAIL" | "ALLOWED_MEMBER_EMAILS" | "AUTOMATION_CLIENT_ID" | "AUTOMATION_SECRET" | "APP_TOKEN" | "MAINTENANCE_CONTROL_TOKEN">> {}
}
