/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=config/types.env` (hash: 3907ef53fe6557f0068a6ba5c5624c34)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "KnowledgeBase" | "AgentSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_INSECURE_LOCAL" | "GITHUB_OAUTH_CLIENT_ID" | "GITHUB_OAUTH_CLIENT_SECRET" | "BOOTSTRAP_ADMIN_EMAIL" | "ALLOWED_MEMBER_EMAILS" | "AUTOMATION_CLIENT_ID" | "AUTOMATION_SECRET" | "APP_TOKEN">> {}
}
