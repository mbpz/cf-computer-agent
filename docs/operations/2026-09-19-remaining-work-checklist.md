...
当前优先恢复主线共 **25 个检查点，2 个关闭，23 个剩余；R03 进行中，前四个子项本地验证完成，下一项为第 5 项集成边界收口**。R01/R02 于 2026-09-20 关闭，见[真实入口本地证据](evidence/2026-09-20-maintenance-entry.md)。前序 0051、备份可行性及备份工具不重复计入；旧测试记录见[迁移证据](../product/2026-09-17-calendar-reference-detach-evidence.md)、[备份工具证据](evidence/2026-09-18-d1-backup-tooling.md)、[协调器证据](evidence/2026-09-19-maintenance-coordinator.md)。2026-09-21 新跑维护专项 118 项及完整应用回归，见[后台及并行任务证据](evidence/2026-09-21-maintenance-continuations.md)，未重跑备份工具测试。
...
- [ ] **R03 — 接管后台与隐式写生命周期。** 覆盖成员 last_seen、session/nonces 清理、嵌套 waitUntil；在业务 catch 之前观察原始失败，保持现有响应语义，失败或结果不明不能被当作安全完成。2026-09-21：前三子项已提交 `b408633`；第 4 项原始后台任务及完整并行分支已本地验证。第 5 项真实入口错误分类、嵌套与迟到调用的完整收口尚未完成，不勾选父项。
...
- 2026-09-21 当前游标：R03 第 5 子项。前三项提交 `b408633`，第 4 项原始后台任务与完整并行 continuation 已验证，见[本地证据](evidence/2026-09-21-maintenance-continuations.md)。恢复总数仍为 2 关闭 / 23 剩余；未执行 R04 或任何生产变更。
