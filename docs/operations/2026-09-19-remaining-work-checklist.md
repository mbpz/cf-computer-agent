...
当前优先恢复主线共 **25 个检查点，3 个关闭，22 个剩余；R04 进行中，5 个子项中的前 3 项本地完成，下一项为 typed R2/DO/VFS 原始失败观察**。R01/R02 于 2026-09-20 关闭，见[真实入口本地证据](evidence/2026-09-20-maintenance-entry.md)；R03 于 2026-09-21 关闭，见[完成边界证据](evidence/2026-09-21-maintenance-r03-completion.md)。R04 生产者登记/最终落库、独立取消链及 timeout/race 分类完成，见[生产者证据](evidence/2026-09-21-maintenance-r04-producer.md)、[取消链证据](evidence/2026-09-22-maintenance-r04-cancel.md)和[本轮超时证据](evidence/2026-09-22-maintenance-r04-timeout.md)。前序 0051、备份可行性及备份工具不重复计入；旧测试记录见[迁移证据](../product/2026-09-17-calendar-reference-detach-evidence.md)、[备份工具证据](evidence/2026-09-18-d1-backup-tooling.md)、[协调器证据](evidence/2026-09-19-maintenance-coordinator.md)。维护专项本轮通过 187 项，完整回归结果以本轮证据为准，未重跑备份工具测试。
