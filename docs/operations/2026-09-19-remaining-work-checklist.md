...
当前优先恢复主线共 **25 个检查点，3 个关闭，22 个剩余；R04 进行中，5 个子项中的第 1 项本地完成，下一项为 cancel 链**。R01/R02 于 2026-09-20 关闭，见[真实入口本地证据](evidence/2026-09-20-maintenance-entry.md)；R03 于 2026-09-21 关闭，见[完成边界证据](evidence/2026-09-21-maintenance-r03-completion.md)。R04 仅生产者登记与最终落库完成，见[本轮证据](evidence/2026-09-21-maintenance-r04-producer.md)。前序 0051、备份可行性及备份工具不重复计入；旧测试记录见[迁移证据](../product/2026-09-17-calendar-reference-detach-evidence.md)、[备份工具证据](evidence/2026-09-18-d1-backup-tooling.md)、[协调器证据](evidence/2026-09-19-maintenance-coordinator.md)。维护专项本轮通过 142 项，完整回归结果以本轮证据为准，未重跑备份工具测试。
...
- [ ] **R04 — 处理流、取消、超时和跨存储尾部工作。** 流生产者与取消链单独登记；逐个分类 Promise.race 的剩余工作，证明没有逃逸的写入能力。DO/R2 路径明确是否能继续触发 D1，不能把 D1 备份当成全系统一致性备份。2026-09-21 第 1 子项本地完成：真实 Agent 生产者启动前登记并等待最终落库，见[证据](evidence/2026-09-21-maintenance-r04-producer.md)；第 2–5 子项仍开放。
...
- 2026-09-21 当前游标：R04 第 2 子项 cancel 链。第 1 子项先红后绿，已等待真实 Agent 生产者与最终落库并保留原始拒绝；维护专项 142 项通过，见[本轮证据](evidence/2026-09-21-maintenance-r04-producer.md)。R04 父项未关闭，恢复总数仍为 3 关闭 / 22 剩余；本轮不推送、不合并 main、不部署，不提升生产交付状态。
