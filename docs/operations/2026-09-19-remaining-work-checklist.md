...
当前优先恢复主线共 **25 个检查点，3 个关闭，22 个剩余；R04 进行中，5 个子项中的前 2 项本地完成，下一项为 timeout/race 分类**。R01/R02 于 2026-09-20 关闭，见[真实入口本地证据](evidence/2026-09-20-maintenance-entry.md)；R03 于 2026-09-21 关闭，见[完成边界证据](evidence/2026-09-21-maintenance-r03-completion.md)。R04 生产者登记/最终落库及独立取消链完成，见[生产者证据](evidence/2026-09-21-maintenance-r04-producer.md)和[本轮取消链证据](evidence/2026-09-22-maintenance-r04-cancel.md)。前序 0051、备份可行性及备份工具不重复计入；旧测试记录见[迁移证据](../product/2026-09-17-calendar-reference-detach-evidence.md)、[备份工具证据](evidence/2026-09-18-d1-backup-tooling.md)、[协调器证据](evidence/2026-09-19-maintenance-coordinator.md)。维护专项本轮通过 150 项，完整回归结果以本轮证据为准，未重跑备份工具测试。
...
- [ ] **R04 — 处理流、取消、超时和跨存储尾部工作。** 流生产者与取消链单独登记；逐个分类 Promise.race 的剩余工作，证明没有逃逸的写入能力。DO/R2 路径明确是否能继续触发 D1，不能把 D1 备份当成全系统一致性备份。第 1 子项已提交 `57cca2e`，见[生产者证据](evidence/2026-09-21-maintenance-r04-producer.md)；2026-09-22 第 2 子项本地完成：分别登记并等待取消链，不 detached、不互等，见[取消链证据](evidence/2026-09-22-maintenance-r04-cancel.md)。第 3–5 子项仍开放。
...
- 2026-09-22 当前游标：R04 第 3 子项 timeout/race 分类。第 2 子项先红后绿，响应与 Agent 取消链独立登记并等待，新增 8 项回归；维护专项 150 项、完整 `npm test` 及类型检查通过，见[取消链证据](evidence/2026-09-22-maintenance-r04-cancel.md)。R04 为 2/5 子项完成，父项仍开放；恢复总数仍为 3 关闭 / 22 剩余。不推送、不合并 main、不部署、不提升生产交付状态。
