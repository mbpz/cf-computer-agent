...
当前优先恢复主线共 **25 个检查点，3 个关闭，22 个剩余；R04 进行中，5 个子项中的前 4 项本地完成，下一项为 R04.5 真实合成资源完整故障矩阵与收口**。R01/R02 于 2026-09-20 关闭，见[真实入口本地证据](evidence/2026-09-20-maintenance-entry.md)；R03 于 2026-09-21 关闭，见[完成边界证据](evidence/2026-09-21-maintenance-r03-completion.md)。R04 生产者登记/最终落库、独立取消链、timeout/race 分类和 typed R2/DO/VFS 原始失败观察完成，见[生产者证据](evidence/2026-09-21-maintenance-r04-producer.md)、[取消链证据](evidence/2026-09-22-maintenance-r04-cancel.md)、[超时证据](evidence/2026-09-22-maintenance-r04-timeout.md)和[本轮存储边界证据](evidence/2026-09-23-maintenance-r04-storage.md)。前序 0051、备份可行性及备份工具不重复计入；旧测试记录见[迁移证据](../product/2026-09-17-calendar-reference-detach-evidence.md)、[备份工具证据](evidence/2026-09-18-d1-backup-tooling.md)、[协调器证据](evidence/2026-09-19-maintenance-coordinator.md)。维护专项本轮通过 237 项，完整回归结果以本轮证据为准，未重跑备份工具测试。
...
- [ ] **R04 — 处理流、取消、超时和跨存储尾部工作。** 流生产者与取消链单独登记；逐个分类 Promise.race 的剩余工作，证明没有逃逸的写入能力。DO/R2 路径明确是否能继续触发 D1，不能把 D1 备份当成全系统一致性备份。第 1 子项已提交 `57cca2e`，见[生产者证据](evidence/2026-09-21-maintenance-r04-producer.md)；第 2 子项已提交 `8c01dc3`：分别登记并等待取消链，不 detached、不互等，见[取消链证据](evidence/2026-09-22-maintenance-r04-cancel.md)。第 3 子项已提交 `2a367d5`，见[超时证据](evidence/2026-09-22-maintenance-r04-timeout.md)。2026-09-23 第 4 子项完成 typed R2/DO/VFS 原始失败观察，新增 50 项回归，237 项维护专项及应用回归全部分项通过，见[存储边界证据](evidence/2026-09-23-maintenance-r04-storage.md)。第 5 子项仍开放，尚未关闭父项。
...
- 2026-09-23 当前游标：R04 第 5 子项真实合成资源完整故障矩阵与收口，尚未完成。第 4 子项先红后绿，原始 R2/DO/VFS 失败在补偿/映射前登记，RPC 内部吞错通过每次调用独立的固定标记传回；正常领域拒绝不标记失败。新增 50 项回归，维护专项 237 项、应用 smoke/unit/worker 全部分项及类型检查通过，见[存储边界证据](evidence/2026-09-23-maintenance-r04-storage.md)。R04 为 4/5 子项完成，父项仍开放，总数仍为 3 关闭 / 22 剩余；不推送、不合并 main、不部署、不提升交付维度。
