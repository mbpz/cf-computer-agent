...
当前优先恢复主线共 **25 个检查点，4 个关闭，21 个剩余；R04 五个子项本地完成，R05 书面规格获准、五步实施计划已编排，尚未实施**。R01/R02 于 2026-09-20 关闭，见[真实入口本地证据](evidence/2026-09-20-maintenance-entry.md)；R03 于 2026-09-21 关闭，见[完成边界证据](evidence/2026-09-21-maintenance-r03-completion.md)；R04 于 2026-09-23 完成限定范围故障矩阵与收口，见[收口证据](evidence/2026-09-23-maintenance-r04-completion.md)。前序 0051、备份可行性及备份工具不重复计入；旧测试记录见[迁移证据](../product/2026-09-17-calendar-reference-detach-evidence.md)、[备份工具证据](evidence/2026-09-18-d1-backup-tooling.md)、[协调器证据](evidence/2026-09-19-maintenance-coordinator.md)。R04 历史验证为维护专项 247 项、应用 smoke/unit/worker 分项及两套类型检查通过；完整结果和限制见收口证据，未重跑备份工具测试，不代表 R05 已通过。生产仍 legacy，R07 完整控制组合矩阵和 R08 候选门禁仍开放。
...
- [ ] **R05 — 完成维护控制面的授权与重放防护。** 独立确认控制方案；本地证明未经授权不能关闸/开闸，窗口和 epoch 严格匹配、重复命令结果一致，旧命令不能重新开闸。业务 cookie/普通成员权限不自动具备维护控制权限。2026-09-23 用户确认[书面规格](../superpowers/specs/2026-09-23-maintenance-control-design.md)，[实施计划](../superpowers/plans/2026-09-23-maintenance-control.md)已编排；R05.1–R05.5 均未执行，不关闭父项。仅本地、不加后台按钮、不改生产配置。
...
- 2026-09-23 当前游标：R05 书面规格获准、实施计划已编排；下一动作是 R05.1 运行时探针与失败测试，五步均未执行。R04 第五子项完成并关闭父项，新增 10 项跨存储组合及三处临时回退验证，维护专项 247 项、应用 smoke/unit/worker 分项和两套类型检查通过，见[收口证据](evidence/2026-09-23-maintenance-r04-completion.md)。这些是 R04 历史验证，不代表 R05 已通过。恢复主线 **4 关闭 / 21 剩余**；本轮不推送、不合并 main、不部署，不提升产品交付维度。
