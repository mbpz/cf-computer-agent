...
当前优先恢复主线共 **25 个检查点，3 个关闭，22 个剩余；R03 五个子项本地验证完成，下一检查点 R04 尚未开始**。R01/R02 于 2026-09-20 关闭，见[真实入口本地证据](evidence/2026-09-20-maintenance-entry.md)；R03 于 2026-09-21 关闭，见[完成边界证据](evidence/2026-09-21-maintenance-r03-completion.md)。前序 0051、备份可行性及备份工具不重复计入；旧测试记录见[迁移证据](../product/2026-09-17-calendar-reference-detach-evidence.md)、[备份工具证据](evidence/2026-09-18-d1-backup-tooling.md)、[协调器证据](evidence/2026-09-19-maintenance-coordinator.md)。本轮新跑维护专项 135 项及完整 `npm test`，未重跑备份工具测试。
...
- [ ] **R04 — 处理流、取消、超时和跨存储尾部工作。** 流生产者与取消链单独登记；逐个分类 Promise.race 的剩余工作，证明没有逃逸的写入能力。DO/R2 路径明确是否能继续触发 D1，不能把 D1 备份当成全系统一致性备份。
...
- 2026-09-21 当前游标：R04，尚未开始。R03 第 5 项已完成并关闭父项，见[收口证据](evidence/2026-09-21-maintenance-r03-completion.md)。恢复总数为 3 关闭 / 22 剩余；本轮不推送、不合并 main、不部署，不提升生产交付状态。
