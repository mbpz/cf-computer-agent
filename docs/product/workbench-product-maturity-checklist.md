...
- [ ] `R6-003` 审核列表/详情支持发布、退回、拒绝和冲突恢复。
  ...
  - D02-R2 已形成 `docs/superpowers/specs/2026-09-16-admin-review-write-recovery-design.md`，复用既有持久化意图和审核决定，按响应/冲突契约、前端结果、审核通知、故障矩阵四批执行。当前仅书面设计与原子拆解，不改变 R6-003 完成状态。
