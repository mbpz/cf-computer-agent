...
- [x] FE-005 记录当前 `npm run check` 基线和构建资源基线；证据：`docs/product/shadcn-ui-frontend-build-baseline.md` 固化 2026-08-26 的 41 smoke、13 i18n、888 unit、298 Worker、类型/构建结果与 4 个 React dist 文件。
