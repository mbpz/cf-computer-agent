...
- [ ] D02 审核/资产/成员/角色/菜单/空间/审计各页主操作逐项跑通。
  - [ ] D02-R1 审核队列与详情读取恢复：原查询重试、权限清理、对象匹配、导航迟到保护和队列到详情回归；[源码核对与原子计划](../superpowers/plans/2026-09-15-admin-review-read-recovery.md)已完成，代码待实施。审核写操作幂等另列 D02-R2，不因读取恢复而完成。
