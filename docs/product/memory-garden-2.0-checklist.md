...
- [ ] `MG2-P1-001` 工作台首页路由和主布局。
- [ ] `MG2-P1-002` 顶部栏：搜索、命令中心、语言、主题、用户菜单。
- [ ] `MG2-P1-003` 一级导航和服务端菜单过滤。
- [ ] `MG2-P1-004` 统一右侧上下文栏。
- [ ] `MG2-P1-005` 页面标题、面包屑和返回行为。
- [ ] `MG2-P1-006` 空状态组件。
- [ ] `MG2-P1-007` 加载状态组件。
- [ ] `MG2-P1-008` 错误状态组件。
- [ ] `MG2-P1-009` `Cmd/Ctrl + K` 命令面板。
- [ ] `MG2-P1-010` 全量中英文文案和占位符校验。
- [ ] `MG2-P1-011` 深色、浅色和减少动态效果。
- [ ] `MG2-P1-012` 移动端降级和键盘导航。
